...
public class HomePage {
  ...
  public void modifyNoteTitle(String newNoteTitle) {
    ...
    wait
      .until(ExpectedConditions.elementToBeClickable(txtNoteTitle))
      .sendKeys(newNoteTitle);
  }

  public void modifyNoteDescription(String newNoteDescription) {
    wait
      .until(ExpectedConditions.elementToBeClickable(txtModifyNoteDescription))
      .clear();
    wait
      .until(ExpectedConditions.elementToBeClickable(txtModifyNoteDescription))
  ...
  public void setNoteDescription(String noteDescription) {
    js.executeScript(
      "arguments[0].value='" + noteDescription + "';",
      txtNoteDescription
    );
  }
  ...
  public boolean noNotes(WebDriver driver) {
    return (
      !isElementPresent(By.id("tableNoteTitle"), driver) &&
  ...
  public boolean noCredentials(WebDriver driver) {
    return (
      !isElementPresent(By.id("tblCredentialUrl"), driver) &&
  ...
  public Note getFirstNote() {
    String title = wait
      .until(ExpectedConditions.elementToBeClickable(tableNoteTitle))
      .getText();
  ...
  public Credential getFirstCredential() {
    String url = wait
      .until(ExpectedConditions.elementToBeClickable(tblCredentialUrl))
      .getText();
